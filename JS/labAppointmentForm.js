...
function validation(){
  if(firstName.value){
    ...
    document.getElementById('firstNameValidation').innerText = 'First Name is required';
  }
  ...
  return apptTime.value && apptDate.value && birthDate.value && contactNo.value && address.value && hosName.value
  && email.value && firstName.value;
}

const appform = document.getElementById('appointmentForm1');
